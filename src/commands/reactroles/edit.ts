...
export default class EditCommand extends Command {
        ...
        super(client, {
            args: [
                ...
                },
                {
                    key: "old",
                    prompt:
                        "What role would you like to replace?",
                    type: "string",
                },
                {
                    key: "new",
                    prompt:
                        "What role would you like to replace it with?",
                    type: "string",
                },
            ],
            description: "Edits the role to be given of a message in the database",
            group: "reactroles",
            memberName: "edit",
            name: "edit",
        });
    ...
    public async run(msg: CommandMessage, args: ICmdArgs) {
        ...
        return msg.say(`I replaced the role **${args.old}** with **${args.new}**`);
    }
}
